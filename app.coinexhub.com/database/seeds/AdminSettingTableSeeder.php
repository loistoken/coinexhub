...
class AdminSettingTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // market bot trade
        AdminSetting::firstOrCreate(['slug' => 'enable_bot_trade'], ['value' => 1]);
        AdminSetting::firstOrCreate(['slug' => 'trading_bot_price_tolerance'], ['value' => 5]);
        AdminSetting::firstOrCreate(['slug' => 'trading_bot_buy_interval'], ['value' => 30]);
        AdminSetting::firstOrCreate(['slug' => 'trading_bot_sell_interval'], ['value' => 30]);
