...
//            $endTime = $time;
            ...
            $socket_data3 = $d_service->getAllOrderSocketData((object)$request);
            $channel_name3 = 'dashboard-'.$order->base_coin_id.'-'.$order->trade_coin_id;
            $event_name3 = 'order_place';
            sendDataThroughWebSocket($channel_name3,$event_name3,$socket_data3);
